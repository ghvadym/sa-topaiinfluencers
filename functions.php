...
{
    wp_enqueue_style('tai-style', get_stylesheet_uri(), [], TAI_VERSION);
    wp_style_add_data('tai-style', 'rtl', 'replace');

    wp_enqueue_script('tai-navigation', get_template_directory_uri() . '/js/navigation.js', [], TAI_VERSION, true);
...
// Цикл
    ...
    while (have_posts()) : the_post();
        ...
        echo '<div class="topai__item"><a href="' . get_permalink() . '" class="topai__link">' . get_the_post_thumbnail() . '</a><a href="' . get_permalink() . '" class="topai__link"><h4 class="topai__title">' . esc_html(get_the_title()) . '</h4><p class="topai__text">' . get_the_excerpt() . '</p></a><div class="author"><div class="author__info">' . get_avatar(get_the_author_meta('user_email'),
                32) . '<a href="' . get_the_author_link() . '" class="author__link"><p class="author__name">' . get_the_author() . '</p></a></div><div class="author__data">' . the_date() . '</div></div></div>';
    endwhile;
    die;
                ...
                <div class="table__row">
                    ...
                    if ($card) :
                        ...
                        <div class="table__social">
                            <?php
                            foreach (['instagram', 'tiktok', 'facebook', 'twitter', 'youtube', 'twitch'] as $platform) {
