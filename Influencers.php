...
?>
	...
	<section class="influencers">
		<h2 class="influencers__article">List of AI Influencers</h2>
		<!-- <div class="influencers__filter">
			<select name="" id="">
...
wp_reset_postdata();
		 ...
		 <div class="topai__row topai__influencers">
		 <?php echo do_shortcode( '[ajax_load_more post_type="post" posts_per_page="8" category="ai-influencers-list" category__not_in="158,159" offset="12"]' ); ?>
		</div>
